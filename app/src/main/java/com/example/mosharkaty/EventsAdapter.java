...
class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.ViewHolder> {
  private ArrayList<EventItem> imageItems;
  private Context context;

  public EventsAdapter(ArrayList<EventItem> imageItems, Context context) {
  ...
  public void onBindViewHolder(@NonNull EventsAdapter.ViewHolder holder, int position) {
    EventItem item = imageItems.get(position);
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void onClick(View view) {
      ...
      EventItem itemClicked = imageItems.get(position);
