...
public class AdminShowConfirmationsActivity extends AppCompatActivity
  ...
  public void filterComing(View view) {
    ...
    for (Map.Entry entry : allConfirmations.entrySet()) {
      if (entry.getValue().equals("جاي")) filtered_confirmations.add(entry.getKey().toString());
    }
  ...
  public void filterMaybe(View view) {
    filtered_confirmations.clear();
    for (Map.Entry entry : allConfirmations.entrySet()) {
      if (entry.getValue().equals("احتمال")) filtered_confirmations.add(entry.getKey().toString());
    }
    adapter.notifyDataSetChanged();
  }
  ...
  public void filterNotComing(View view) {
    filtered_confirmations.clear();
    for (Map.Entry entry : allConfirmations.entrySet()) {
      if (entry.getValue().equals("معتذر")) filtered_confirmations.add(entry.getKey().toString());
    }
    adapter.notifyDataSetChanged();
  }
