...
public class ProfileFragment extends androidx.fragment.app.Fragment {
    ...
    int month, officialCount, mycounter;
    ValueEventListener Mosharkatlistener;
  ...
  public View onCreateView(
                          ...
                          public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                              ...
                              for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                  ...
                                  if (user != null && user.code.equalsIgnoreCase(userCode)) {
                                      currentMosharkatOfficial.setText(String.valueOf(user.count));
                                      officialCount = user.count;
    ...
    private void updateMosharkatUI() {
        ...
        float percentage = (float) Math.min(Math.max(officialCount, mycounter), 8) / 8 * 100;
