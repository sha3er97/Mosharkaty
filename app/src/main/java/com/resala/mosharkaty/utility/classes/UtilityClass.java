...
public class UtilityClass {
    ...
    public static String[] meetingsTypesNormal = {
            "اجتماع لجنة فرق",
            "اجتماع لجنة معارض و اطفال",
            "اجتماع لجنة اطعام",
            "اجتماع لجنة اعمار",
            "اجتماع لجنة السوق الخيري",
            "اجتماع لجنة ابطال التحدي",
            "اجتماع لجنة hr",
            "اجتماع لجنة متابعة",
            "اجتماع لجنة اتصالات",
            "اجتماع لجنة اشبال",
            "اجتماع لجنة دعايا",
            "اجتماع لجنة مكافحة",
            "اجتماع لجنة تحقيق اماني",
            "اجتماع لجنة اخلاقيات",
            "اجتماع لجنة نقل",
            "اجتماع لجان مجمع",
            "اجتماع ادارة الفرع",
            "اجتماع مسؤولين",
    ...
    public static String[] meetingsTypesMarkzy = {
            "اجتماع مركزية فرق",
            "اجتماع مركزية معارض و اطفال",
            "اجتماع مركزية اطعام",
            "اجتماع مركزية اعمار",
            "اجتماع مركزية السوق الخيري",
            "اجتماع مركزية ابطال التحدي",
            "اجتماع مركزية hr",
            "اجتماع مركزية متابعة",
            "اجتماع مركزية اتصالات",
            "اجتماع مركزية اشبال",
            "اجتماع مركزية مكافحة",
            "اجتماع مركزية تحقيق اماني",
            "اجتماع مركزية اخلاقيات",
            "اجتماع لجنة دعايا",
            "اجتماع مركزية نقل",
