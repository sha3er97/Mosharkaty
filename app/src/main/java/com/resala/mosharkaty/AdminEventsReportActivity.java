...
import com.resala.mosharkaty.ui.adapters.EventsReportsPagerAdapter;

public class AdminEventsReportActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_admin_events_report);
    EventsReportsPagerAdapter sectionsPagerAdapter =
            new EventsReportsPagerAdapter(this, getSupportFragmentManager());
    ...
    textTab0.setText(getString(R.string.events_reports_tab_text_1));
    ...
    textTab1.setText(getString(R.string.events_reports_tab_text_2));
    ImageView imageViewTab1 = tab1.getCustomView().findViewById(R.id.icon);
    imageViewTab1.setImageResource(R.drawable.tick);
  }
}
